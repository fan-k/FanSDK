#
#  Be sure to run `pod spec lint FanSDK.podspec' to ensure this is a
...
描述啊 暂时还没写z呢 咋办啊
  ...
  spec.source       = { :git => "https://github.com/fan-k/FanSDK.git", :tag => "1.0.0" }
...
#spec.framework  = "UIKit"
   ...
   spec.vendored_frameworks = 'FanSDK/FanFrameworks/FanSDK.framework'
  # spec.library   = "iconv"
